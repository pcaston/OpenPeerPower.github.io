...
For DSM/Synology, install via debian-chroot [see this forum post](https://community.openpeerpower.io/t/error-starting-home-assistant-on-synology-for-first-time/917/15).
