...
In Open Peer Power 0.45 we introduced the first version of our automation editor. If you just created a new configuration with Open Peer Power, then you're all set! Go to the UI and enjoy.
