...
This guide will help you get Open Peer Power running on a Raspberry Pi, turning your Raspberry Pi into the ultimate home automation hub.
...
We will need a few things to get started with installing Open Peer Power. The Raspberry Pi 4 Model B is a good, affordable starting point for your home automation journey. Links below lead to Amazon US. If you're not in the US, you should be able to find these items in web stores in your country.
