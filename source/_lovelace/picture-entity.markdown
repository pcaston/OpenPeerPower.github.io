...
The filename needs to be a path that is writable by Open Peer Power in your system. You may need to configure `whitelist_external_dirs` ([documentation](/docs/configuration/basic/)).
